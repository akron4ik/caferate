...
public class CafeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (StringUtils.isEmpty(request.getParameter("id"))) {
            //cafeController.create(meal);
        } else {
            //cafeController.update(cafe, getId(request));
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action == null ? "all" : action) {
            ...
            case "all":
            default:
                request.setAttribute("cafes", cafeController.getAll());
                request.getRequestDispatcher("/cafes.jsp").forward(request, response);
                break;
        }
    }
